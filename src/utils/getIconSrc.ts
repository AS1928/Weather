// Importing weather icons from the assets folder
...
/**
 * Function to return the appropriate weather icon based on the weather code and time of day.
 * @param weatherCode - Numerical code representing the weather condition.
 * @param night - Boolean indicating if it's nighttime.
 * @returns The corresponding image source for the given weather condition.
 */
